...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HNCommentsTree.lft'
        db.add_column(u'reader_hncommentstree', 'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'HNCommentsTree.rgt'
        db.add_column(u'reader_hncommentstree', 'rgt',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'HNCommentsTree.tree_id'
        db.add_column(u'reader_hncommentstree', 'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'HNCommentsTree.depth'
        db.add_column(u'reader_hncommentstree', 'depth',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HNCommentsTree.lft'
        db.delete_column(u'reader_hncommentstree', 'lft')

        # Deleting field 'HNCommentsTree.rgt'
        db.delete_column(u'reader_hncommentstree', 'rgt')

        # Deleting field 'HNCommentsTree.tree_id'
        db.delete_column(u'reader_hncommentstree', 'tree_id')

        # Deleting field 'HNCommentsTree.depth'
        db.delete_column(u'reader_hncommentstree', 'depth')
