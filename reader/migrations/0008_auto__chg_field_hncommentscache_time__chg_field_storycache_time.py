...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HNCommentsCache.time'
        db.alter_column('reader_hncommentscache', 'time', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'StoryCache.time'
        db.alter_column('reader_storycache', 'time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'HNCommentsCache.time'
        db.alter_column('reader_hncommentscache', 'time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 10, 24, 0, 0)))

        # Changing field 'StoryCache.time'
        db.alter_column('reader_storycache', 'time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 10, 24, 0, 0)))
