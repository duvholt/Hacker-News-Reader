...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'reader_poll', 'name', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'Stories.cache'
        db.alter_column(u'reader_stories', 'cache', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Poll.name'
        db.alter_column(u'reader_poll', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Stories.cache'
        db.alter_column(u'reader_stories', 'cache', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

    models = {
        u'reader.hncomments': {
            'Meta': {'ordering': "['dead', 'cache']", 'object_name': 'HNComments'},
