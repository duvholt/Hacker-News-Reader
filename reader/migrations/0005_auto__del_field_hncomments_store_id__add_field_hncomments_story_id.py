...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HNComments.store_id'
        db.delete_column('reader_hncomments', 'store_id')

        # Adding field 'HNComments.story_id'
        db.add_column('reader_hncomments', 'story_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'HNComments.store_id'
        db.add_column('reader_hncomments', 'store_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, max_length=10),
                      keep_default=False)

        # Deleting field 'HNComments.story_id'
        db.delete_column('reader_hncomments', 'story_id')
