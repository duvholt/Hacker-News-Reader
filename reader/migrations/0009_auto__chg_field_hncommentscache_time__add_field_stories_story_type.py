...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('reader_hncommentscache', 'time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))
        # Adding field 'Stories.story_type'
        db.add_column('reader_stories', 'story_type',
                      self.gf('django.db.models.fields.CharField')(default='news', max_length=30),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Stories.story_type'
        db.delete_column('reader_stories', 'story_type')
