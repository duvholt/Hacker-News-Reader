...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Stories.selfpost_text'
        db.alter_column('reader_stories', 'selfpost_text', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Stories.selfpost_text'
        db.alter_column('reader_stories', 'selfpost_text', self.gf('django.db.models.fields.TextField')())
